...
public class BoardResponse {
    ...
    @Builder
    private BoardResponse(Long boardId, String userName, String restaurantName, String contentUrl, String content, Category category, int likeCount,List<CommentResponse> comments) {
